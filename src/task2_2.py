...
# 3. Calculate min price, max price, and row count with exact column aliases
...
# 4. Save as a CSV file under out/out_2_2.txt
# Using coalesce(1) ensures the output is written into a single CSV part-file
result_df.coalesce(1).write \
    .mode("overwrite") \
    .option("header", "true") \
    .csv("C:/Users/Sakshi/PycharmProjects/PythonProject/OSN/out/out_2_2.txt")